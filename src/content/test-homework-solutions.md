...
| 约束 | 含义 |
| --- | --- |
| C1、C2 为唯一约束 O | 一次投币只能是 5 元或 10 元，有且仅有一个成立 |
| C3、C4 为唯一约束 O | 一次只能按橙汁或啤酒，有且仅有一个成立 |
| C5 是二值状态 | 有零钱为 `1`，无零钱为 `0`，不再单独设 C6 |
...
| 规则 | 含义 |
| --- | --- |
| R1 | 5 元 + 橙汁 + 有零钱：红灯灭，出橙汁 |
| R2 | 5 元 + 橙汁 + 无零钱：红灯亮，仍出橙汁 |
| R3 | 5 元 + 啤酒 + 有零钱：红灯灭，出啤酒 |
| R4 | 5 元 + 啤酒 + 无零钱：红灯亮，仍出啤酒 |
| R5 | 10 元 + 橙汁 + 有零钱：红灯灭，出橙汁，退 5 元 |
| R6 | 10 元 + 橙汁 + 无零钱：红灯亮，不出饮料，退 10 元 |
| R7 | 10 元 + 啤酒 + 有零钱：红灯灭，出啤酒，退 5 元 |
| R8 | 10 元 + 啤酒 + 无零钱：红灯亮，不出饮料，退 10 元 |

### 3.5 测试用例表

| ID | 对应规则 | 投入金额 | 选择按钮 | 零钱状态 | 预期结果 |
| --- | --- | --- | --- | --- | --- |
| TC1 | R1 | 5 | 橙汁 | 有零钱 | 红灯灭，送出橙汁，不退款 |
| TC2 | R2 | 5 | 橙汁 | 无零钱 | 红灯亮，送出橙汁，不退款 |
| TC3 | R3 | 5 | 啤酒 | 有零钱 | 红灯灭，送出啤酒，不退款 |
| TC4 | R4 | 5 | 啤酒 | 无零钱 | 红灯亮，送出啤酒，不退款 |
| TC5 | R5 | 10 | 橙汁 | 有零钱 | 红灯灭，送出橙汁，退还 5 元 |
| TC6 | R6 | 10 | 橙汁 | 无零钱 | 红灯亮，不送饮料，退还 10 元 |
| TC7 | R7 | 10 | 啤酒 | 有零钱 | 红灯灭，送出啤酒，退还 5 元 |
| TC8 | R8 | 10 | 啤酒 | 无零钱 | 红灯亮，不送饮料，退还 10 元 |
